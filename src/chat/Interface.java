...
public class Interface {
		...
		textField.addActionListener(e -> {
			...
			if (!message.isEmpty()) {
				if (selectedUser != null) {
					...
					// conversion en String pour facilité l'envoi et la stabilité du message
					String crypt = "";
					...
					try {
					//doublement du message crypté pour des raisons de dépendance au serveur
	...
	private void handleIncomingMessage(String message)
		...
		if (message.startsWith("(De ")) {
			...
			messageArea.append(message.substring(0, endIndex+1)+new String(messa) + "\n");
		}
	}
